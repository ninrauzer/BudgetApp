      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white border-2 border-border rounded-3xl shadow-lg p-8">
          ...
          <button
            type="button"
            disabled
            className="w-full flex items-center justify-center gap-3 py-3 mb-4 bg-black/5 border-2 border-border text-text-muted rounded-xl font-semibold cursor-not-allowed opacity-60"
