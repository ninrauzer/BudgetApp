...
export default function Budget() {
  ...
  return (
    <div className="space-y-6">
      {/* Header - Responsive with horizontal scroll on mobile */}
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 px-3 md:px-8">
        <div>
          <h1 className="text-2xl md:text-h1 font-bold text-text-primary">
            Presupuesto {viewType === 'monthly' && selectedCycle}
          </h1>
        ...
        <div className="overflow-x-auto -mx-3 px-3 md:mx-0 md:px-0">
          <div className="flex items-center gap-3 pb-2 md:pb-0">
            {/* Month Selector (only for Monthly view, which is always active on mobile) */}
            {viewType === 'monthly' && (
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                {currentCycle && selectedCycle === currentCycle.cycle_name && (
                  <span className="px-3 py-1 rounded-full bg-success/10 text-success text-sm font-bold whitespace-nowrap">
                    Actual
                  </span>
                )}
              </div>
          ...
          {/* Currency Toggle */}
          <div className="flex items-center gap-2 bg-surface border border-border rounded-xl p-1 flex-shrink-0">
            <button
          ...
          {/* View Type Selector - Hidden on mobile */}
          <div className="hidden md:flex items-center gap-2 bg-surface border border-border rounded-xl p-1 flex-shrink-0">
            <button
          ...
          {/* Year Selector - Only visible in desktop when annual view is selected */}
          {viewType === 'annual' && (
            <div className="hidden md:block relative bg-white border border-border rounded-xl p-1 shadow-sm flex-shrink-0">
